...
abstract interface class IAuthService {
  TaskEither<Failure, bool> checkForAdmin(String uID);
...
final class AuthService implements IAuthService {
  ...
  @override
  TaskEither<Failure, bool> checkForAdmin(String value) => TaskEither<Failure, bool>.tryCatch(
        () async {
        ...
        (error, stackTrace) => CheckAdminFailure(
          error: error,
