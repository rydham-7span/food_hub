...
@RoutePage()
class RegisterAdminScreen extends StatefulWidget implements AutoRouteWrapper {
...
class _RegisterAdminScreenState extends State<RegisterAdminScreen> {
  ...
  Widget build(BuildContext context) {
    return CommonScaffoldWidget(
      appBarText: LocaleKeys.register.tr(),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CommonTextField(
                      ...
                      hintText: LocaleKeys.enter_business_name.tr(),
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(top: 25, left: 25),
                            ...
                            context.read<AuthBloc>().add(
                                  SignUpEvent(
                                    userModel: userModel.copyWith(
                                      ...
                                      isAdmin: true,
                                      restaurantId: math.Random().nextInt(99999999).toString(),
                                    ),
                                  ),
                                );
                          }
